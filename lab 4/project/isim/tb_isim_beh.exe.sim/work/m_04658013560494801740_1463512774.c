...
#endif
static const char *ng0 = "/home/ise/CS_152A/lab 4/src/segdisplay.v";
static int ng1[] = {0, 0};
...
LAB20:    t363 = (t0 + 7616);
    ...
    *((unsigned int *)t373) = (t375 | t369);
    xsi_driver_vfirst_trans(t363, 0, 7U);
    t376 = (t0 + 7472);
    *((int *)t376) = 1;
...
LAB26:    t7 = ((char*)((ng18)));
    t31 = xsi_vlog_unsigned_case_xcompare(t8, 4, t7, 32);
    if (t31 == 1)
        goto LAB27;

LAB28:    t2 = ((char*)((ng24)));
    t30 = xsi_vlog_unsigned_case_xcompare(t8, 4, t2, 32);
    if (t30 == 1)
        goto LAB29;
...
LAB51:    t3 = ((char*)((ng18)));
    t31 = xsi_vlog_unsigned_case_xcompare(t5, 4, t3, 32);
    if (t31 == 1)
        goto LAB52;

LAB53:    t2 = ((char*)((ng24)));
    t30 = xsi_vlog_unsigned_case_xcompare(t5, 4, t2, 32);
    if (t30 == 1)
        goto LAB54;
...
LAB76:    t3 = ((char*)((ng18)));
    t31 = xsi_vlog_unsigned_case_xcompare(t7, 4, t3, 32);
    if (t31 == 1)
        goto LAB77;

LAB78:    t2 = ((char*)((ng24)));
    t30 = xsi_vlog_unsigned_case_xcompare(t7, 4, t2, 32);
    if (t30 == 1)
        goto LAB79;
...
LAB101:    t3 = ((char*)((ng18)));
    t31 = xsi_vlog_unsigned_case_xcompare(t21, 4, t3, 32);
    if (t31 == 1)
        goto LAB102;

LAB103:    t2 = ((char*)((ng24)));
    t30 = xsi_vlog_unsigned_case_xcompare(t21, 4, t2, 32);
    if (t30 == 1)
        goto LAB104;
...
LAB52:    xsi_set_current_line(143, ng0);
    t7 = ((char*)((ng23)));
    t21 = (t0 + 4928);
    xsi_vlogvar_wait_assign_value(t21, t7, 0, 0, 7, 0LL);
    goto LAB74;
...
LAB102:    xsi_set_current_line(179, ng0);
    t22 = ((char*)((ng23)));
    t28 = (t0 + 4928);
...
LAB104:    xsi_set_current_line(180, ng0);
    t3 = ((char*)((ng25)));
    t22 = (t0 + 4928);
    xsi_vlogvar_wait_assign_value(t22, t3, 0, 0, 7, 0LL);
    goto LAB124;
...
extern void work_m_04658013560494801740_1463512774_init()
{
	static char *pe[] = {(void *)NetDecl_46_0,(void *)NetDecl_58_1,(void *)NetDecl_70_2,(void *)NetDecl_82_3,(void *)Always_107_4};
	xsi_register_didat("work_m_04658013560494801740_1463512774", "isim/tb_isim_beh.exe.sim/work/m_04658013560494801740_1463512774.didat");
